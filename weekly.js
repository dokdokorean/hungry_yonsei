...
//점심메뉴 1번 (국이름만 수정)
document.getElementById('lunch-menu1-2').innerText='천원의 아침밥 - '+ '금주는'
//점심메뉴 2번 
document.getElementById('lunch-menu2-2').innerText='추석 연휴로 인해'
//점심메뉴 3번 
document.getElementById('lunch-menu3-2').innerText='메뉴가'
//점심메뉴 4번 
document.getElementById('lunch-menu4-2').innerText='제공되지'
//점심메뉴 5번 
document.getElementById('lunch-menu5-2').innerText='않습니다'

//수요일

//중식특식
document.getElementById('china-special2-3').innerText=''
...
//점심메뉴 4번 
document.getElementById('lunch-menu4-3').innerText='제공되지'
//점심메뉴 5번 
document.getElementById('lunch-menu5-3').innerText='않습니다'
...
//점심메뉴 4번 
document.getElementById('lunch-menu4-4').innerText='제공되지'
//점심메뉴 5번 
document.getElementById('lunch-menu5-4').innerText='않습니다'
...
//점심메뉴 4번 
document.getElementById('lunch-menu4-5').innerText='제공되지'
//점심메뉴 5번 
document.getElementById('lunch-menu5-5').innerText='않습니다'
